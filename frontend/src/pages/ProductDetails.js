...
const ProductDetails = () => {
  ...
  return (
    <div className='container mx-auto p-4 font-poppins'>
      ...
      <div className='min-h-[200px] flex flex-col lg:flex-row gap-4 mt-28'>
          {/***product Image */}
          <div className='h-96 flex flex-col lg:flex-row-reverse gap-4 '>

              <div className='h-[300px] w-[300px] lg:h-96 lg:w-96 bg-slate-200 relative p-2 rounded-lg'>
                    ...
                    {/**product zoom */}
                    {
                      zoomImage && (
                        <div className='hidden lg:block absolute min-w-[500px] overflow-hidden min-h-[400px] bg-slate-200 p-1 -right-[510px] top-0 '>
                          <div
                            className='w-full h-full min-h-[400px] min-w-[500px] mix-blend-multiply scale-145'
                            style={{
                      ...
                      <div className='flex gap-2 lg:flex-col overflow-scroll scrollbar-none h-full '>
                        {
                          data?.productImage?.map((imgURL,index) =>{
                            return(
                              <div className='h-20 w-20 bg-slate-200 rounded-lg p-1' key={imgURL}>
           ...
           {/***product details */}
           {
            ...
            (
              <div className='flex flex-col gap-1'>
                <p className='bg-teal-300 text-teal-800 px-6 rounded-full inline-block w-fit'>{data?.brandName}</p>
                ...
                <div className='flex items-center gap-2 text-xl lg:text-2xl font-medium my-1'>
                  <p className='text-red-600'>{displaySLCurrency(data.sellingPrice)}</p>
                  <p className='text-slate-400 line-through'>{displaySLCurrency(data.price)}</p>
                </div>
